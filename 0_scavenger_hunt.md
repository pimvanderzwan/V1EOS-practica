# EOS Opdracht 0 — Linux Scavenger Hunt
...
## Benodigde bestanden
Download de Linux `scavenger-hunt` van [GitHub](https://github.com/pushingice/scavenger-hunt) met behulp van `cd; git clone git clone https://github.com/pushingice/scavenger-hunt.git
